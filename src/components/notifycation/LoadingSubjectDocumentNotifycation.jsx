...
function LoadingSubjectDocumentNotifycation({ notifycation }) {
  const {
    notifications: { LOADING },
  } = useSelector((state) => state.notificationState);
  const dispatch = useDispatch();

  const { documents, startTime, status, subject, subjectDocument } =
    notifycation;
  const close = () => {
    dispatch(
...
export default LoadingSubjectDocumentNotifycation;
