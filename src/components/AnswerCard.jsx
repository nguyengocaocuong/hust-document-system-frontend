          ...
          docs: [
            {
              uri: location.pathname.startsWith("/post/")
                ? `https://hust-document-system-backend-vxw4qk34wa-as.a.run.app/api/v1/users/posts/${id}/answer/${answer?.id}/readFile`
                : `https://hust-document-system-backend-vxw4qk34wa-as.a.run.app/api/v1/users/subjects/subjectDocument/${id}/answerSubjectDocument/${answer.id}/readFile`,
