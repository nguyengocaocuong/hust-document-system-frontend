          ...
          docs: [
            {
              uri: location.pathname.startsWith("/post/")
                ? `${process.env.REACT_APP_BASE_URL}/users/posts/${id}/answer/${answer?.id}/readFile`
                : `${process.env.REACT_APP_BASE_URL}/users/subjects/subjectDocument/${id}/answerSubjectDocument/${answer.id}/readFile`,
