...
import { closeReportDuplicateSubjectDocumentModal } from "../../store/modalState";
...
function ReportDuplicateSubjectDocumentModal({ open }) {
  const dispatch = useDispatch();
  const closeModal = () => {
    dispatch(closeReportDuplicateSubjectDocumentModal());
  };
  const {
    reportDuplicateSubjectDocumentModal: { dataModal },
          ...
          <Box width={"49.59%"}>
            ...
            >
              <DocumentViewer
                docs={[
                  {
                    uri: `https://hust-document-system-backend-vxw4qk34wa-as.a.run.app/api/v1/api/v1/admins/subjects/subjectDocuments/${dataModal.subjectDocumentFirst.id}/readFile`,
          ...
          <Box width={"49.9%"}>
            ...
            >
              <DocumentViewer
                docs={[
                  {
                    uri: `https://hust-document-system-backend-vxw4qk34wa-as.a.run.app/api/v1/api/v1/admins/subjects/subjectDocuments/${dataModal.subjectDocumentSecond.id}/readFile`,
...
export default ReportDuplicateSubjectDocumentModal;
